...
int main(void) {
    ...
    while (!WindowShouldClose()) { // Detect window close button or ESC key
        ...
        // GetFrameTime() returns the time it to draw the last frame, in seconds (usually called delta time)
        ...
        // If either circles is off the screen, reset it back to the start
